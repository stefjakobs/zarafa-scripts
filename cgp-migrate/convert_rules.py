# Copyright (c) 2014 Mark Dufur, Stefan Jakobs
#####################################################################
...
TEST_ACCOUNT ='''
{
 ...
 Rules = (
    ...
    (2,from_is_move,((To,is,"*user@gmail.com*")),(("Store in","taktak"),(Discard))),
    ...
    (0,subject_is_fwd,((Subject,is,"*banaan*")),(("Forward to",user@gmail.com),(Discard))),
    (0,subject_is_redir,((Subject,is,"*banaan*")),(("Redirect to",user@gmail.com),(Discard)))
 );
 UseAppPassword = YES;
 UseExtPassword = NO;
}'''
